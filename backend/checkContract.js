...
async function checkContract() {
    try {
        ...
        console.log(`Current souvenirNFT: ${souvenirNFT}`);
        console.log(`Relayer account: ${account.address}`);
        console.log(`Is relayer the travel manager? ${travelManager.toLowerCase() === account.address.toLowerCase()}`);
        ...
        try {
            ...
            console.log(`Frog #1 status: ${frog[3]}`); // status is at index 3
