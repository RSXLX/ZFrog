...
export const config = {
  ...
  ERC6551_REGISTRY_ADDRESS: process.env.ERC6551_REGISTRY_ADDRESS || '',
  ERC6551_ACCOUNT_IMPLEMENTATION: process.env.ERC6551_ACCOUNT_IMPLEMENTATION || '',
  ERC6551_SALT: process.env.ERC6551_SALT || '0',
