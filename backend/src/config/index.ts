...
export const config = {
  ...
  // Contracts
  ZETAFROG_NFT_ADDRESS: process.env.ZETAFROG_NFT_ADDRESS || '0x76e7baA23fce77DA7Edbea58D8B888128D47A1Ff',
  SOUVENIR_NFT_ADDRESS: process.env.SOUVENIR_NFT_ADDRESS || '0x9eC88079939357EC5Efe59d1687AC8b85f65857b',
