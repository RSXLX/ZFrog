...
export const isJourneyBetaEnabled = (): boolean => {
  const fromWindow =
    typeof window !== 'undefined'
      ? (window as unknown as { __ZFROG_V3_JOURNEY_BETA__?: unknown }).__ZFROG_V3_JOURNEY_BETA__
      : undefined;
...
export const getJourneyIntegrationApiKeySeed = (): string | null => {
  const fromWindow =
    typeof window !== 'undefined'
